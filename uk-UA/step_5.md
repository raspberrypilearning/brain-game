...
+ Потрібно відредагувати код об'єктів так, щоб гра запускалась, коли вони отримають повідомлення про `початок`, а не коли ви натиснули на прапорець.
    
    Замініть код `коли натиснуто ⚑`{:class="blockevents"} на `коли я отримаю `{:class="blockevents"} повідомлення про початок.
